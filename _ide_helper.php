...
namespace Spatie\Menu\Laravel {
    ...
    class MenuFacade
    {
         ...
         * @static
         */
        public static function routeIf($condition, $name, $text, $parameters = [], $absolute = true, $route = null)
        {
         ...
         * @static
         */
        public static function routeIfCan($authorization, $name, $text, $parameters = [], $absolute = true, $route = null)
        {
